...
export type VerticalId = "cafe" | "hotel" | "shop" | "other";

export const VERTICALS: readonly VerticalId[] = ["cafe", "hotel", "shop", "other"] as const;
...
export const TYPICAL_POINTS: Record<VerticalId, number> = {
  cafe: 12,
  hotel: 30,
  // A shop is one or two points — the door and the till — and is priced as a
  // venue anyway, so the number is small on purpose.
  shop: 2,
  other: 8,
};
