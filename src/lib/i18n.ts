...
const SITE = {
  uz: {
    ...
    heroTitleA: "Flex —",
    heroTitleMark: "Cheksiz",
    heroTitleB: "imkoniyatlaringiz",
  ...
  ru: {
    ...
    heroTitleA: "Flex — Ваши",
    heroTitleMark: "бесконечные",
    heroTitleB: "возможности",
  ...
  en: {
    ...
    heroTitleMark: "infinite",
    heroTitleB: "possibilities",
