...
const PICKER = {
  uz: {
    ...
    samplesLabel: "Profil qanday ko'rinadi",
    samplesNote: "Yettita maket va o'n to'rtta tashkilot kartasi",
    samplesCta: "Namunalarni ko'rish",
  ...
  ru: {
    ...
    samplesLabel: "Как выглядит профиль",
    samplesNote: "Семь макетов и четырнадцать карт организаций",
    samplesCta: "Посмотреть образцы",
  ...
  en: {
    ...
    samplesLabel: "What the profile looks like",
    samplesNote: "Seven layouts and fourteen organisation cards",
    samplesCta: "See the samples",
