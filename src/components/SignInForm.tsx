    ...
    return (
      <div className="text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-lime/20">
          <MailCheck className="h-6 w-6 text-mynt-black" />
        </div>
        <h2 className="mt-5 font-display text-xl font-semibold">Xat yuborildi</h2>
        <p className="mt-2 text-sm text-mynt-black/60">
          <span className="font-medium text-mynt-black">{state.email}</span> manziliga kirish
          havolasi yubordik. Xatni oching va havolani bosing.
        </p>
        <p className="mt-4 text-xs text-mynt-black/40">
