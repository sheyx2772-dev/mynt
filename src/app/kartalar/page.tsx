...
export const metadata: Metadata = {
  title: "Kartalar — flex.uz",
  description:
    "FLEX CARD dizaynlari: har biri Flex uchun chizilgan, NFC va QR bilan ishlaydi.",
};
    ...
    <div className="relative min-h-full overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mt-3 max-w-xl text-flex-black/60">
          Har bir dizayn Flex uchun chizilgan. Kartada NFC chip va QR-kod bo&apos;ladi — tegizasiz
        ...
        <div className="mt-12 grid gap-x-8 gap-y-10 sm:grid-cols-2">
          {CARD_DESIGNS.map((design) => (
            <div key={design.id}>
              ...
              <p className="mt-1 text-sm text-flex-black/55">{design.description}</p>
            </div>
          ))}
        </div>
