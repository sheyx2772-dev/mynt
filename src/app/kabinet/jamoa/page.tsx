...
export default async function JamoaPage() {
  ...
  if (!team) {
    return (
      <PageShell>
        ...
        <div className="mt-8 space-y-3 text-sm text-flex-black/70">
          <p>
        ...
        <div className="mt-8 rounded-2xl border border-black/10 bg-black/[0.02] px-6 py-5">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <a
              ...
              className="rounded-xl bg-flex-black px-5 py-2.5 text-[11px] font-semibold tracking-[0.16em] text-white uppercase"
            >
              {COMPANY.phone}
            </a>
            <Link
  ...
  return (
    <PageShell>
      <p className="text-[11px] font-medium tracking-[0.18em] text-flex-black/40 uppercase">
        Firma
      </p>
      ...
      <div className="mt-6 grid grid-cols-3 gap-3">
        <div className="rounded-2xl border border-black/8 bg-black/[0.02] px-4 py-3">
          ...
          <p className="mt-0.5 text-xs text-flex-black/45">Band</p>
        </div>
        <div className="rounded-2xl border border-black/8 bg-black/[0.02] px-4 py-3">
          <p className="font-display text-2xl font-semibold tabular-nums">
            {Math.max(0, team.seats - taken)}
          </p>
          <p className="mt-0.5 text-xs text-flex-black/45">Bo&apos;sh o&apos;rin</p>
        </div>
        <div className="rounded-2xl border border-black/8 bg-black/[0.02] px-4 py-3">
          <p className="font-display text-2xl font-semibold tabular-nums">{team.seats}</p>
          <p className="mt-0.5 text-xs text-flex-black/45">Jami</p>
        </div>
      </div>
