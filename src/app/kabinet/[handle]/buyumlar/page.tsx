    ...
    <PageShell wide>
      <SubScreen handle={normalized} title="Buyumlar">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start">
          <div>
            <h2 className="mb-3 text-[12px] font-medium tracking-wide text-flex-black/40 uppercase">
          ...
          <div>
            ...
            {messages.length === 0 ? (
              <p className="rounded-2xl border border-dashed border-black/12 p-8 text-center text-[13px] text-flex-black/45">
                Hozircha xabar yo&apos;q.
              </p>
            ) : (
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-black/[0.05]">
                          <Icon className="h-3.5 w-3.5 text-flex-black/55" />
                        </span>
                        <div className="min-w-0 flex-1">
                          <p className="text-[14px] font-semibold tracking-tight">
                            {words.actions[message.kind]}
                          </p>
                          <p className="mt-0.5 text-[12px] text-flex-black/40">
                      ...
                      {message.place && (
                        <p className="mt-2.5 flex items-center gap-1.5 text-[13px] text-flex-black/60">
                      ...
                      {message.body && (
                        <p className="mt-2 border-l-2 border-black/8 pl-3 text-[13px] leading-relaxed text-flex-black/70">
                          {message.body}
                        </p>
                      )}
                      ...
                      {message.replyTo && (
                        <a
                          ...
                          className="mt-3 inline-flex items-center gap-1.5 rounded-xl bg-flex-black px-3.5 py-2 text-[12px] font-semibold text-white transition-transform hover:scale-[1.02]"
                        >
