...
export default async function QrPage({ params }: PageProps<"/kabinet/[handle]/qr">) {
  ...
  return (
    <PageShell>
      ...
      >
        <div className="rounded-[1.75rem] border border-black/10 bg-white p-7 text-center shadow-[0_30px_60px_-30px_rgba(14,10,27,0.25)]">
          <div className="mx-auto w-64 max-w-full rounded-2xl border border-black/10 p-5">
          ...
          <p className="mt-5 font-tabular text-sm text-flex-black/45">
